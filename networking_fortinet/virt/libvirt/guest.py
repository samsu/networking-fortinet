...
from networking_fortinet.virt import hardware
from networking_fortinet.virt.libvirt import compat
...
LIBVIRT_POWER_STATE = {
    VIR_DOMAIN_NOSTATE: const.NOSTATE,
    VIR_DOMAIN_RUNNING: const.RUNNING,
    ...
    VIR_DOMAIN_BLOCKED: const.RUNNING,
    VIR_DOMAIN_PAUSED: const.PAUSED,
    ...
    VIR_DOMAIN_SHUTDOWN: const.SHUTDOWN,
    VIR_DOMAIN_SHUTOFF: const.SHUTDOWN,
    VIR_DOMAIN_CRASHED: const.CRASHED,
    VIR_DOMAIN_PMSUSPENDED: const.SUSPENDED,
}
...
class Guest(object):
    ...
    def detach_device_with_retry(self, get_device_conf_func, device,
        ...
        if conf is None:
            raise exceptions.DeviceNotFound(device=device)
        ...
        @loopingcall.RetryDecorator(max_retry_count=max_retry_count,
                                    ...
                                    exceptions=exceptions.DeviceDetachFailed)
