...
class OVSNeutronAgent(sg_rpc.SecurityGroupAgentRpcCallbackMixin,
    ...
    def _restore_local_vlan_map(self):
        ...
        port_names = set([p.port_name for p in cur_ports])
        ...
        for port in cur_ports:
            ...
            if (net_uuid and net_uuid not in self._local_vlan_hints
                ...
                self.available_local_vlans.remove(str(local_vlan))
        ...
        while self._check_and_handle_signal():
            ...
            if self._agent_has_updates(polling_manager) or ovs_restarted:
                try:
                    ...
                    print "## ofport_changed_ports =", ofport_changed_ports
                    print "## port_info1 = ", port_info
                    print "## ovs_restarted = ", ovs_restarted
                    ...
                    # on Neutron server
                    LOG.debug("### ovs_restarted=%(ovs_restarted)s, port_info=%(port_info)s, ancillary_brs=%(br)s",
                              {'ovs_restarted': ovs_restarted, 'port_info': port_info, 'br': self.ancillary_brs})
