...
class FortinetL3PluginApi(fortinet_agent_rpc.FortinetAgentRpcApi):
    ...
    def __init__(self, topic, host):
        super(FortinetL3PluginApi, self).__init__(topic, host)


class FortinetAgent(firewall_l3_agent.FWaaSL3AgentRpcCallback,
                 ha.AgentMixin,
                 dvr.AgentMixin,
                 manager.Manager):
    ...
    def _router_added(self, router_id, router):
        ...
        router = ri.create_router(router)
        import ipdb;ipdb.set_trace()
        self.plugin_rpc.update_data(self.context, data=router)
...
class L3NATAgentWithStateReport(FortinetAgent):
